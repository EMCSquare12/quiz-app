    ...
    <div className="flex flex-col items-center justify-center w-full h-auto">
      ...
      <div className="flex items-center justify-center h-full">
        <div className="flex md:flex-row flex-col w-full h-auto  border border-purple-200 shadow bg-gray-50 md:w-[70%] shadow-purple-200">
          ...
          <div className="md:w-[50%] w-full  bg-purple-100 md:border-l border-l-transparent md:border-t-transparent border-t border-purple-200 gap-8 flex flex-col h-auto p-4 md:p-8 ">
            <div className="flex flex-col justify-between h-full gap-3 md:gap-8">
              {width > 768 && (
                <div className="flex flex-col gap-4">
                  <div className="flex flex-row gap-4">
                    <h1 className="text-xs font-bold text-purple-900 font-poppins md:text-sm">
                      DIFFICULTY:
                    </h1>
                    <h2 className="px-2 py-1 text-xs font-medium text-purple-600 bg-purple-200 md:text-sm font-poppins w-fit">
                      {textUpperCase(difficulty)}
                    </h2>
                  </div>
                  <div className="flex flex-col gap-4">
